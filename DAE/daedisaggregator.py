...
class DAEDisaggregator(Disaggregator):
    ...
    def _create_model(self, sequence_len, method):
        ...
        model.add(Dense((sequence_len-0)*8, activation='relu',input_shape=(sequence_len, 1),
        kernel_initializer=initializers.RandomNormal(mean=0.1, stddev=0.1)))#provare con linear sui dense
